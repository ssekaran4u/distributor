    ...
    <body class="fixed-left">
                                                ...
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control distributor_id js-select2-multi" name="distributor_id" id="distributor_id">
                                                            <option value="0">--Select Distributors Name--</option>
                                                            <?php
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control dealer_id js-select3-multi" name="dealer_id" id="dealer_id">
                                                    ...
                                                    <div class="col-md-3" style="margin-top: 20px;">
                                                        ...
                                                        <input type="hidden" name="method" id="method_" value="add_dealer_price">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#distributor_id').on('change', function (e) {
                    $('#preloader').show();
                    $('#status').show();
                    ...
                    $.ajax({
                        ...
                        {
                            $('#dealer_id').empty();
                            $('#dealer_id').html(response['result']);
                            alertHelper();
                        }   
                    });
