                                    ...
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-allowance"><i class="fa fa-plus-circle"></i>  Add New City</a> </h4>
