                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card m-b-30">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage News Letter</strong></h4>

                                            <hr>

                                            <div class="col-md-6 pdz">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search by Email..." value="">
