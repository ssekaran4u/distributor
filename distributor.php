    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    ?>
                                                                ...
                                                                <option value="2" <?php echo $select;?> >Distributor</option>  
                                                                <option value="3" <?php echo $select;?> >Dealer</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                  	<?php
                                                    ...
                                                    ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <lable>TCS.Option <span class="text-danger">*</span> </lable>
                                                                <br>
                                                                <div class="typesimpo" style="margin-top: 12px;">
                                                                    <input <?php echo $fetch->tcs_type==1 ? 'checked':''; ?> type="radio" class="tcs_type" name="tcs_type" value="1"> No
                                                                    <input <?php echo $fetch->tcs_type==2 ? 'checked':''; ?> type="radio" class="tcs_type" name="tcs_type" value="2"> Yes
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 qtyval <?php echo $fetch->tcs_type==2 ? 'show':'hide'; ?>">
                                                            <div class="form-group">
                                                                <lable>TAN.No <span class="text-danger">*</span> </lable>
                                                                <input  type="text" name="tcs_no" class="form-control tcs_no" id="tcs_no" placeholder="TAN.No" value="<?php echo isset($fetch->tcs_no) ? $fetch->tcs_no : '' ?>">
                                                            </div>
                                                        </div>
                                                    <?php
                                                        }
                                                    ...
                                                    ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <br>
                                                                <div class="typesimpo" style="margin-top: 12px;">
                                                                    <input type="radio" class="tcs_type" name="tcs_type" value="1" checked> No
                                                                    <input type="radio" class="tcs_type" name="tcs_type" value="2"> Yes
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 qtyval hide">
                                                            <div class="form-group">
                                                                <lable>TAN.No <span class="text-danger">*</span> </lable>
                                                                <input  type="text" name="tcs_no" class="form-control tcs_no" id="tcs_no" placeholder="TAN.No" value="<?php echo isset($fetch->tcs_no) ? $fetch->tcs_no : '' ?>">
                                                            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('change','.tcs_type', function () {
