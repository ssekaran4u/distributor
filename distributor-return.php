...
$inv_no = mysqli_fetch_object(mysqli_query($conn, "SELECT COUNT(id) AS id FROM `ss_distributor_return` WHERE published = '1' AND status = '1'"));

if($inv_no)
{
    $val = $inv_no->id + 1;
    $unique   = "YARA-DRET".leadingZeros($val, 5);
}
else
{
    $val = 1;
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Create Sales Return</strong> <a class="pull-right btn btn-pink" href="distributor-return-list"><i class="fa fa-plus-circle"></i> Manage Sales Return</a></h4>
                                            <hr>
                                            ...
                                            <form id="add-form" name="add-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                        ...
                                                        <input  type="text" style="background-color: #fff;" readonly="readonly" name="re_no" id="re_no" class="form-control" placeholder="Return Code" value="<?php echo isset($fetch->userno) ? $fetch->userno : $unique; ?>">
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control so_no[] js-select2-multi" name="so_no" id="so_no">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#pid').change(function(){   
                    ...
                    if(pid != '')    
                    {
                        $.ajax({
                        type: "POST",
                        url: "inc/select_distributor_return_code.php",
            ...
            $(document).ready(function (e) {
                $('#add-form').on('submit', function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'AjaxFunction/AjaxDistRet.php',
