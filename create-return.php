...
$fetch = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM `ss_sales` WHERE `id` = '".$id."' LIMIT 1"));

$result = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM `ss_sales_details` WHERE `auto_id` = '".$auto_id."' LIMIT 1"));
...
if($auto_id)
{
    ...
    $product = mysqli_fetch_object(mysqli_query($conn, "SELECT COUNT(*) As extra FROM ss_item_stk WHERE dist_id = ".$userid." AND delar_status = 1 AND status = 0 AND product_id = ".$result->pid." AND published = '1'"));

}



$inv_no = mysqli_fetch_object(mysqli_query($conn, "SELECT COUNT(id) AS id FROM `ss_sales_return` WHERE published = '1' AND status = '1'"));

if($inv_no)
{
    $val = $inv_no->id + 1;
    $unique   = "YARA-RETU".leadingZeros($val, 5);
}
else
{
    $val = 1;
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Create Sales Return</strong> <a class="pull-right btn btn-pink" href="manage-sales"><i class="fa fa-plus-circle"></i> Manage Sales Return</a></h4>
                                            <hr>
                                            ...
                                            <form id="add-form" name="add-form" method="post" enctype="multipart/form-data">
                                                        ...
                                                        ?>
                                                            <div class="row clearfix mb20">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input  type="text" name="re_dno" class="form-control" id="re_dno" style="background-color: #fff;" readonly="readonly" placeholder="Invoice No" value="<?php echo isset($fetch->re_dno) ? $fetch->re_dno : $unique; ?>">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control dist_name js-select4-multi" name="dist_name" id="dist_name">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <span>Dealer Name <span class="text-danger">*</span> </span>
                                                                    ...
                                                                    <input  type="hidden" name="dist_name" id="dist_name" class="dist_name form-control" value="">
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix mb20">
                                                                <div class="col-md-4">
                                                                    <span>Sales Invoice <span class="text-danger">*</span> </span>
                                                                    <select class="form-control so_no[] js-select1-multi" name="so_no" id="so_no">
                                                                        <option value="">Select Dealer name</option>    
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-4">
                                                            ...
                                                            <div class="row clearfix mb20">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control customer_name[] js-select1-multi" name="customer_id" id="customer_id">
                                                                        ...
                                                                        $a = mysqli_query($conn, "SELECT * FROM ss_customers WHERE userid = '".$_SESSION['uid']."' AND published = 1  AND status = 1 ORDER BY id ASC");
                                                                        while($rowo = mysqli_fetch_array($a)) {
                                                                        $select='';
                                                                        if($rowo['id'] == $fetch->customer_id) 
                                                                        {
                                                    ...
                                                    <div class="qtyval hide">
                                                        ...
                                                        <div class="row clearfix mb20">
                                                            <div class="col-md-12">
                                                                ...
                                                                <select class="form-control code[] js-select7-multi" name="code[]" id="code" multiple="multiple">
                                                                    ...
                                                                    <?php
                                                                        if($auto_id){
                                                                            $a = mysqli_query($conn, "SELECT * FROM ss_item_stk WHERE cid = '".$result->cid."' AND product_id = '".$result->pid."' AND dist_id = ".$userid." AND delar_status = 1 AND status = '0' UNION SELECT * FROM ss_item_stk WHERE cid = '".$result->cid."' AND product_id = '".$result->pid."' AND delar_sales = '".$result->so_no."' ORDER BY id ASC ");
                                                                            while($rowo = mysqli_fetch_array($a)) {
                                                                                $select='';
                                                                                if($rowo['delar_sales'] == $result->so_no) 
                                                                                {
                                                                                    $select ="selected";
                                                                                }
                                                                                ?>
                                                        ...
                                                        <div class="row clearfix mb20">
                                                            <!-- <div class="col-md-3">
                                                                ...
                                                                <input  type="text" name="allowance" id="allowance" class="form-control" placeholder="Basic Allowance" style="background-color: #fff;" readonly="readonly" value="<?php echo isset($result->allowance)?$result->allowance:'0'; ?>">
                                                            </div> -->
                                                            <!-- <div class="col-md-3">
                                                                <span>STA <span class="text-danger">*</span> </span>
                                                                <input  type="text" name="sta" id="sta" class="form-control" placeholder="STA" style="background-color: #fff;" readonly="readonly" value="<?php echo isset($result->sta)?$result->sta:'0'; ?>">
                                                            </div> -->
                                                            <!-- <div class="col-md-3">
                                                                <span>Delar Allowance <span class="text-danger">*</span> </span>
                                                                <input  type="text" name="d_allowance" id="d_allowance" class="form-control" placeholder="Delar Allowance" style="background-color: #fff;" readonly="readonly" value="<?php echo isset($result->d_allowance)?$result->d_allowance:'0'; ?>">
                                                            </div> -->
                                                            <!-- <div class="col-md-3">
                                                ...
                                                <button type="submit" id="add-forms" class="btn btn-danger waves-effect waves-light add-form"> <i  class="mdi mdi-check-circle-outline"></i> <?php echo isset($result->auto_id)?'Update':'Add'; ?> Sales Return </button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#pid').change(function(){   
                    ...
                    if(pid != '')    
                    {
                        $.ajax({
                        type: "POST",
                        url: "inc/select_dealer_return_code.php",
                        data: {"customer_id":customer_id,"so_no":so_no,"pid":pid}
                        }).done(function( msg ) {
                            var dataArr1 = msg.split('^');
                            $('#stock').val(dataArr1[1]); 
                            var dataArr = dataArr1[0].split('#');
                            ////console.log(dataArr);
                            $('#code option').remove();
                ...
                $('#dist_name').change(function(){         
                    ...
                    $.ajax({
                    type: "POST",
                    url: "inc/select_distcustomer.php",
                    data: {"dist_name":dist_name}
                        ...
                        $.each(dataArr, function(i,element){
                            if(dataArr[i]!=""){
                                var dataArr2 = dataArr[i].split('~');
                                $('#customer_id').append("<option value='"+dataArr2[0]+"'>"+dataArr2[1]+"</option>");
                            }
                        });
                    });
                });
                ...
                $('#customer_id').change(function(){         
                    ...
                    data: {"customer_id":customer_id}
                        ...
                        $.each(dataArr, function(i,element){
                            if(dataArr[i]!=""){
                                var dataArr2 = dataArr[i].split('~');
                                $('#so_no').append("<option value='"+dataArr2[0]+"'>"+dataArr2[1]+"</option>");
                            }
                        });
                    });
                });
            ...
            $(document).ready(function (e) {
                $('#add-form').on('submit', function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'AjaxFunction/AjaxSalesReturn.php',
                ...
                $(document).on('click', '.complete_inv', function () {
                    ...
                    $.ajax({
                        ...
                        url:"inc/complete-inv-dealer.php",
                        dataType: 'json',
                    }).done(function (response) {
                        $('#status').hide();
                        $('#preloader').hide();
            ...
            function loadCreatePoint() {
                ...
                if(customer_id != '')    
                {
                    $.ajax({
                    type: "POST",
                    url: "inc/manage-createpoint.php",
                    data: {"customer_id":customer_id}
                    }).done(function( msg ) {
                        var dataArr = msg.split('#');
                        $.each(dataArr, function(i,element){
