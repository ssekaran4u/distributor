                ...
                $html .= '
                    <tbody>
                        <tr>
                            ...
                            <td style="font-size:12px; width: 30%;"> '.$_RES->title.'</td>
                            <td style="font-size:12px; width: 20%;"> '.$code->title.'</td>
                            <td style="font-size:12px; width: 10%; text-align: center;">'.$brand->brand.'</td>
                            <td style="font-size:12px; width: 15%;"> '.$_RES->description.'</td>
                            <td style="font-size:12px; text-align: center; width: 10%;">'.$_RES->extra.'</td>
                            <td style="font-size:12px; text-align: center; width: 10%;">'.$_RES->oprice.'</td>
                        </tr>
                    </tbody>
                ';
