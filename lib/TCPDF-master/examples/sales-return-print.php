...
$addressdetail = mysqli_query($conn, "SELECT * FROM `ss_sales_return`  WHERE `id` = '".$order."' LIMIT 1");
            ...
            while($_RES = mysqli_fetch_object($_QRY))
            {
                ...
                $html .= '
                    <tr>
                        ...
                        <td style="font-size:12px; width: 30%;">'.$_RES->description.'</td>
                        <td style="font-size:12px; text-align: center; width: 20%;">'.$_RES->hsn.'</td>
                        <td style="font-size:12px; text-align: right; width: 20%;">'.$_RES->oprice.'</td>
                        <td style="font-size:12px; text-align: center; width: 20%;">'.$_RES->qty.'</td>
                    </tr>
                ';
