...
<table border= "1" cellpadding="1" top="100">
        <tr>
            <td rowspan="6" style="font-size:12px; width: 55%;">Shipped To: <br>'.$cname.'<br>'.$name.'<br>'.$address.', '.$pincode.'<br>'.$mobile.'<br>'.$s_name.', Code:'.$state.'<br>GSTIN\UIN :'.$gst_no.'</td>
