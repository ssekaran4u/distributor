...
<html>
    ...
    <body class="fixed-left">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Invoice</strong></h4>
                                            <hr>

                                            <div class="col-md-6 pdz">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search Invoice Name..." value="">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="distributor-invoice"><i class="fa fa-plus-circle"></i>  Add Invoice</a> </h4>
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="sorting" data-sort="0">
                                                                ...
                                                                <i class="filter hide fa fa-sort show"></i> Invoice No
                                                            ...
                                                            <th class="sorting" data-sort="2">
                                                                ...
                                                                <i class="filter hide fa fa-sort show"></i> Mobile Number
        ...
        <script src="assets/Ajax/ajax-dist-inv.js"></script>    
        <script type="text/javascript">
            $(document).ready(function (e) {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    $.ajax({
                      type: 'POST',
                      url: 'AjaxFunction/DeleteDisSales.php',
                      data: {
                        'id': saleid,
                        'method': 'delete',
                        'target': 'sales'
