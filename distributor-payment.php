                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Payment</strong></h4>
                                            <hr>

                                            <div class="col-md-6 pdz">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search" value="">
            ...
            $(document).ready(function () {
              ...
              function loadSelectBox() {
                ...
                $.ajax({
                  ...
                  url: 'inc/distributor-invoice-list.php'
              ...
              function loadInCartitems(page, sort, order, search, categories) {
                ...
                $.ajax({
                  ...
                  url: 'inc/distributor-payment.php',
