...
$qry = "SELECT * FROM `ss_distributor_return` WHERE `published` = '1' ";
if($_SESSION['type'] =='2')
{
...
$qry .= " ORDER BY `ss_distributor_return`.`".$nsort."` ".$order." LIMIT $start_from, $num_rec_per_page";
// echo $qry; die;
$selectquery = mysqli_query($conn, $qry);
$numrows = mysqli_num_rows($selectquery);
$cats = "SELECT * FROM `ss_distributor_return` WHERE `published` = '1'";
if(isset($search))
{
...
?>
    ...
    $i = 1;
        ...
        $cname   = isset($customer->owner)?$customer->owner:'---';
        ...
        <tr id="<?php echo $row['id']; ?>">
            ...
            <td class="text-center">
                <a href="<?php echo "view-bill-dist-ret?id=".$row['id'];?>"><span class="btn btn-sm btn-success"> <i class="mdi mdi-eye"></i>  View </span> </a>
