...
$qry = "SELECT * FROM `ss_distributor_payment` WHERE `published` = '1' AND customer_id = '".$customer_id."' ";
if($search)
{
...
$cats = "SELECT * FROM `ss_distributor_payment` WHERE `published` = '1' AND customer_id = '".$customer_id."'";
if(isset($search))
{
