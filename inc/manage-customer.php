...
?>
    ...
    $i = 1;
        while($row = mysqli_fetch_array($selectquery)) {
             ...
             if($id)
             {
                $order=mysqli_fetch_object(mysqli_query($conn,"SELECT COUNT(*) as count  FROM `ss_sales` where `customer_id`='".$id."'"));
             }
        ...
        <tr>
            ...
            ?>
            <!-- <td> 
               <a href="manage-invoice?type=1&id=<?php echo $id; ?>"><?php echo $count;?></a>
            </td> -->
            <td class="text-center">
                <a href="<?php echo "create-dealer?id=".$row['id'];?>"><span class="btn btn-sm btn-info"> <i class="mdi mdi-pencil"></i>  Edit </span> </a>
