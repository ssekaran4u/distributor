                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <form id="event-form" name="event-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                        <span>Event Name <span class="text-danger">*</span> </span>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <input required type="text" name="title" class="form-control" placeholder="Event Name">
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control desc kudu" placeholder="Description" name="description"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                        <span>Event Image <span class="text-danger">*</span> </span>
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <hr>
                                                <input type="hidden" name="method" value="add-event"> 
                                                <button type="submit" id="event-forms" class="btn btn-danger waves-effect waves-light add-event"> <i  class="mdi mdi-check-circle-outline"></i> Add Event </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
