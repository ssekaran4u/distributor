                                    ...
                                    <div class="card text-center m-b-30">
                                        <div class="mb-2 card-body text-muted">
                                            <h3 class="text-info">
                                                <a href="manage-sales">
                                                <?php
                                                $result = mysqli_fetch_object(mysqli_query($conn,"SELECT COUNT(*) as count FROM `ss_sales` where `status`='1'"));
                                        ...
                                        <div class="mb-2 card-body text-muted">
                                            <h3 class="text-primary">
                                                <a href="manage-customer">
                                                    <?php
                                                    $result = mysqli_fetch_object(mysqli_query($conn,"SELECT COUNT(*) as count FROM `ss_customers` WHERE `name`!='' AND `status`='1'"));
                                                    echo $result->count?$result->count:'0';
                                                    ?>
                                                </a>
                                            </h3>
