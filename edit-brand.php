                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    if(isset($_GET['id']))
                                    {
                                        $fetch=mysqli_fetch_object(mysqli_query($conn, "select * from `ss_brands` where id='".$_GET['id']."'"));
                                        if($fetch !='')
                                        {
                                        ?>
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Create Brand</strong> <a class="pull-right btn btn-pink" href="manage-brand"><i class="fa fa-plus-circle"></i> Manage Brand</a></h4>
                                            <hr>
                                            ...
                                            <form id="brand-form" name="brand-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-6">
                                                        <span>Brand Name <span class="text-danger">*</span> </span>
                                                        <input  type="text" name="brand" class="form-control" placeholder="Brand Name" value="<?php echo $fetch->brand; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <span>Brand Code <span class="text-danger">*</span> </span>
                                                        <input  type="text" name="code" class="form-control" placeholder="Brand Code" value="<?php echo $fetch->code; ?>">
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                ...
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                        <span>Brand Image <span class="text-danger">*</span> </span>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label>Image sholud be 500x500</label>
                                                        <?php if($fetch->image): ?>
                                                         <img src="images/brand/<?php echo $fetch->image; ?>" class="img-upload2">
                                                         <?php else: ?>
                                                ...
                                                <input type="hidden" name="method" value="edit-brand">
                                                <button type="submit" class="btn btn-danger waves-effect waves-light edit-brand"> <i  class="mdi mdi-check-circle-outline"></i> Edit Brand </button>
                                            </form>
                                        </div>
                                    </div>
                                    <?php 
