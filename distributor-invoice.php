                                            ...
                                            <form id="add-form" name="add-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input  type="hidden" name="cus_type" id="cus_type" class="form-control" placeholder="Cus Type">
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <button type="submit" id="add-forms" class="btn btn-danger waves-effect waves-light add-form"> <i  class="mdi mdi-check-circle-outline"></i> <?php echo isset($id)?'Update':'Add'; ?> Invoice </button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.delete-item', function () {
                    ...
                    $.ajax({
                      type: 'POST',
                      url: 'AjaxFunction/DeleteDisItem.php',
                      data: {
                        'id': id,
                        'method': 'delete',
                        'target': 'item'
