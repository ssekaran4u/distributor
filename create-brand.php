                                            ...
                                            <form id="brand-form" name="brand-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input  type="text" name="code" class="form-control" placeholder="Brand Code">
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                ...
                                                <hr>
                                                <input type="hidden" name="method" value="add-brand"> 
                                                <button type="submit" id="brand-forms" class="btn btn-danger waves-effect waves-light add-brand"> <i  class="mdi mdi-check-circle-outline"></i> Add Brand </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
