                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <form id="cate-form" name="cate-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                        <span>Category Name <span class="text-danger">*</span> </span>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <input required type="text" name="title" class="form-control" placeholder="Category Name">
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                ...
                                                <!-- <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                        <span>Category Image <span class="text-danger">*</span> </span>
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <hr>
                                                <input type="hidden" name="method" value="add-category"> 
                                                <button type="submit" id="cate-forms" class="btn btn-danger waves-effect waves-light add-category"> <i  class="mdi mdi-check-circle-outline"></i> Add Category </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
