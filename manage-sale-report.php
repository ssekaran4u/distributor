                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Sales Wise Report</strong></h4>
                                            <hr>
                                                ...
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-control distributor_id js-select1-multi selectpicker" name="distributor_id" id="distributor_id">
                                                            <?php
                                                                $a = mysqli_query($conn, "SELECT * FROM `ss_distributors` WHERE `isAdmin` != '1' AND `deleted` = '1' ORDER BY `id` ASC ");
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-control dealer_id js-select1-multi selectpicker" name="dealer_id" id="dealer_id">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(document).on('change','#distributor_id', function () {
                    ...
                    type : "POST",
                    url  : "inc/admin-login.php",
                    data : {"distributor_id":distributor_id, "method":"_getDealer"},
                    dataType: 'json',
                    }).done(function(response) {
                        ...
                        if(response['status'] == true)
                        {
                            $('.dealer_id').empty().html(response['result']);
                        } 
                        else
                        {
                            $('.dealer_id').empty().html(response['result']);
                ...
                $(document).on('change','#distributor_id', function () {
                    ...
                    type : "POST",
                    url  : "inc/admin-login.php",
                    data : {"distributor_id":distributor_id, "method":"_getDisInvoice"},
                    dataType: 'json',
                    }).done(function(response) {
                        console.log(response['result']);
                        $('#preloader').hide();
                ...
                $(document).on('change','#dealer_id', function () {
                    ...
                    type : "POST",
                    url  : "inc/admin-login.php",
                    data : {"dealer_id":dealer_id, "method":"_getDeaInvoice"},
                    dataType: 'json',
                    }).done(function(response) {
                        console.log(response['result']);
                        $('#preloader').hide();
