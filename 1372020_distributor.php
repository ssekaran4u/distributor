...
$disid = mysqli_fetch_object(mysqli_query($conn, "SELECT COUNT(id) AS id FROM `ss_distributors` WHERE `deleted` = '1' ORDER BY id DESC LIMIT 1 "));

if($disid)
{
    $val = $disid->id + 1;
    $unique   = "YARA-DIS".leadingZeros($val, 5);
}
else
{
    $val = 1;
                                            ...
                                            <form id="form-data" name="form-data" method="post">
                                                ...
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-3 hide">
                                                        <div class="form-group">
                                                            <label>Dealer Allowance <span class="text-danger">*</span></label>
                                                            <input  type="text" name="d_allowance" class="form-control d_allowance" placeholder="Note: Enter Percentage Value" value="<?php echo isset($fetch->d_allowance) ? $fetch->d_allowance : '1' ?>">
                                                        </div>
                                                    </div>
