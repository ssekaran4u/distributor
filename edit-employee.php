                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    if(isset($_GET['id']))
                                    {
                                        $fetch=mysqli_fetch_object(mysqli_query($conn, "select * from `ss_employee` where id='".$_GET['id']."'"));
                                        if($fetch !='')
                                        {
                                        ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="eate-form" name="cate-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-3">
                                                        <span>Distributors <span class="text-danger">*</span> </span>
                                                        <select class="form-control brand_id[] js-select5-multi" name="d_id" id="d_id">
                                                            <option value="">Select Distributors name</option>
                                                            <?php
                                                                $a = mysqli_query($conn, "SELECT * FROM ss_distributors WHERE published = '1' AND status = '1' ORDER BY name ASC ");
                                                                while($rowo = mysqli_fetch_array($a)) {
                                                                    $select='';
                                                                if($rowo['id'] == $fetch->d_id) 
                                                                {
                                                                    $select ="selected";
                                                                }
                                                                ?>     
                                                ...
                                                <button type="submit" class="btn btn-danger waves-effect waves-light edit-employee"> <i  class="mdi mdi-check-circle-outline"></i> Edit Employee </button>
                                            </form>
                                        </div>
                                    </div>
                                    <?php 
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".js-select5-multi").select2({
                placeholder: "Select Distributors Name"
            });
        });
    </script>
    </body>
