...
$fetch = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM `ss_distributors` WHERE `id` = '".$id."' LIMIT 1"));
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong><?php echo isset($fetch->id) ? 'Add' : 'Add'; ?> Payment</strong> <a class="pull-right btn btn-pink" href="distributor-payment"><i class="fa fa-plus-circle"></i> Manage Payment</a></h4>
                                            <hr>
        ...
        <script type="text/javascript">
            $(document).ready(function (e) {
                ...
                $('#edit-form').on('submit', function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'AjaxFunction/AjaxDistPayment.php',
                ...
                function loadOrderBox() {
                    ...
                    $.ajax({
                        ...
                        url:"inc/distributor-balance.php",
                    }).done(function (response) {
                        $('#status').hide();
                        $('#preloader').hide();
                        if (response == 1)
