...
<html>
    ...
    <body class="fixed-left">
                                   ...
                                   <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-sales"><i class="fa fa-plus-circle"></i>  Add Invoice</a> </h4>
        ...
        <script src="assets/Ajax/ajax-sales.js"></script>    
        <script type="text/javascript">
            ...
            $(document).ready(function (e) {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    $.ajax({
                      type: 'POST',
                      url: 'AjaxFunction/DeleteSales.php',
                      data: {
                        'id': saleid,
                        'method': 'delete',
                        'target': 'sales'
