...
<html>
    ...
    <body class="fixed-left">
                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Store</strong></h4>
                                            <hr>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-store"><i class="fa fa-plus-circle"></i>  Add New Store</a> </h4>
        ...
        <script src="assets/Ajax/ajax-store.js"></script>
    </body>
</html>