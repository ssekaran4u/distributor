                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong><?php echo isset($fetch->id) ? 'Edit' : 'Add'; ?> Serice</strong> <a class="pull-right btn btn-pink" href="manage-items"><i class="fa fa-plus-circle"></i> Manage Service</a></h4>
                                            <hr>
                                            ...
                                            <form id="<?php echo isset($fetch->id) ? 'edit' : 'add'; ?>-form" name="<?php echo isset($fetch->id) ? 'edit' : 'add'; ?>-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input  type="text" name="service_no" class="form-control service_no" id="service_no" placeholder="Service Number" value="<?php echo isset($fetch->sta) ? $fetch->sta : '' ?>">
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-5">
                                                        ...
                                                        <select class="form-control product_id[] js-select5-multi" name="p_id" id="p_id">
