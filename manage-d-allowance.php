                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Allowance</strong></h4>
                                            <hr>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-d-allowance"><i class="fa fa-plus-circle"></i>  Add New Allowance</a> </h4>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sorting" data-sort="1">
                                                                <i class="filter hide fa fa-sort show"></i> Description
                                                            </th>
           ...
           $(document).ready(function () {
              ...
              function loadInCartitems(page, sort, order, search) {
                ...
                $.ajax({
                  ...
                  url: 'inc/manage-d-allowance.php',
            ...
            $(document).on('click', '.delete-d-allowance', function () {
              //alert('dshgfdhg');
