...
$sale_no = mysqli_fetch_object(mysqli_query($conn, "SELECT COUNT(id) AS id FROM `ss_sales` WHERE published = '1' AND status = '1'"));

$sale_re = $sale_no->id + 1;

$so_no   = "HS".leadingZeros($sale_re, 5);
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Create Invoice</strong> <a class="pull-right btn btn-pink" href="manage-sales"><i class="fa fa-plus-circle"></i> Manage Invoice</a></h4>
                                            <hr>
                                            ...
                                            <form id="add-form" name="add-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <?php 
                                                        ...
                                                        <div class="col-md-<?php echo $len;?>">
                                                            ...
                                                            <select class="form-control customer_name[] js-select1-multi" name="customer_id" id="customer_id">
                                                                ...
                                                                $a = mysqli_query($conn, "SELECT * FROM ss_customers WHERE published = 1 ".$qry." AND status = 1 ORDER BY id ASC");
                                                                while($rowo = mysqli_fetch_array($a)) {
                                                                $select='';
                                                                if($rowo['id'] == $fetch->customer_id) 
                                                                {
                                                    ...
                                                    <div class="col-md-<?php echo $len;?>">
                                                        ...
                                                        <input  type="text" style="background-color: #fff;" readonly="readonly" name="mobile" id="mobile" class="form-control" placeholder="Mobile Number">
                                                      	<input  type="hidden" name="tcs_type" id="tcs_type" class="form-control" placeholder="TCS Type">
                                                    </div>
                                                    <div class="col-md-<?php echo $len;?>">
                                                    ...
                                                    <div class="qtyval hide">
                                                        ...
                                                        <div class="row clearfix mb20">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <input  type="text" name="price" id="price" class="form-control" placeholder="Rate" value="<?php echo isset($result->price)?$result->price:''; ?>" readonly="readonly" style="background-color: #fff !important;" >
                                                            </div>
                                                            <!-- <div class="col-md-3">
                                                        ...
                                                        <div class="row clearfix mb20">
                                                            <div class="col-md-3">
                                                                ...
                                                                <input  type="text" name="allowance" id="allowance" class="form-control" placeholder="Basic Allowance" value="<?php echo isset($result->allowance)?$result->allowance:'0'; ?>">
                                                                <code>Note: Enter Percentage Value</code>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <span>STA <span class="text-danger">*</span> </span>
                                                                <input  type="text" name="sta" id="sta" class="form-control" placeholder="STA" value="<?php echo isset($result->sta)?$result->sta:'0'; ?>">
                                                                <code>Note: Enter Amount Value</code>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <span>Delar Allowance <span class="text-danger">*</span> </span>
                                                                <input  type="text" name="d_allowance" id="d_allowance" class="form-control" placeholder="Delar Allowance" value="<?php echo isset($result->d_allowance)?$result->d_allowance:'0'; ?>">
                                                                <code>Note: Enter Percentage Value</code>
                                                            </div>
                                                            <div class="col-md-3">
                                                ...
                                                <button type="submit" id="add-forms" class="btn btn-danger waves-effect waves-light add-form"> <i  class="mdi mdi-check-circle-outline"></i> <?php echo isset($result->auto_id)?'Update':'Add'; ?> Product </button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                    ...
                    if(product_id != '')    
                    {
                        $.ajax({
                            ...
                            data: {
                                ...
                                "method"      : "dealer_invoice"
                            },
                            dataType: 'json',
                        }).done(function(response) {
                            if(response['status'] == true)
                            {
                                $('#description').empty().val(response['description']);
                                $('#price').empty().val(response['price_val']);
                                $('#gst').empty().val(response['gst']);
                                $('#allowance').empty().val(response['allowance']);
                                $('#sta').empty().val(response['sta']);
                                $('#hsn').empty().val(response['hsn']);
                                $('#stock').empty().val(response['extra']);
                            }
                            else
                            {
                ...
                $('#pid').change(function(){   
                    ...
                    if(pid != '')    
                    {
                        $.ajax({
                        type: "POST",
                        url: "inc/select_deal_code.php",
                        data: {"pid":pid,"dist_name":dist_name}
                        }).done(function( msg ) {
            ...
            $(document).ready(function (e) {
                $('#add-form').on('submit', function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'AjaxFunction/AjaxSales.php',
