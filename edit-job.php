                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    if(isset($_GET['id']))
                                    {
                                        $fetch=mysqli_fetch_object(mysqli_query($conn, "select * from `ss_job` where id='".$_GET['id']."'"));
                                        if($fetch !='')
                                        {
                                        ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="eate-form" name="cate-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input required type="text" name="name" class="form-control" placeholder="Job Name" value="<?php echo $fetch->name;?>">
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control desc kudu" placeholder="Job Description" name="description"><?php echo $fetch->description; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <div class="col-md-2">
                                                ...
                                                <input type="hidden" name="method" value="edit-job">
                                                <button type="submit" class="btn btn-danger waves-effect waves-light edit-job"> <i  class="mdi mdi-check-circle-outline"></i> Edit Job </button>
                                            </form>
                                        </div>
                                    </div>
                                    <?php 
