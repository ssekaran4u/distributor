                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Sales Executive</strong></h4>
                                            <hr>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-sales-executive"><i class="fa fa-plus-circle"></i>  Add New Sales Executive</a> </h4>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title text-left">Sales Executive Info</h4>
                    </div>
           ...
           $(document).ready(function () {
              ...
              function loadInCartitems(page, sort, order, search) {
                ...
                $.ajax({
                  ...
                  url: 'inc/manage-sales-executive.php',
