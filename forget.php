...
<html>
    ...
    <body>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <form method="POST" id="_UForget" onclick="return false;">
                            <div class="form-group">
                                <input type="text" name="Femail" class="form-control" placeholder="Enter your email">
                            </div>
                            <div class="form-group text-center">
                                <input type="hidden" name="method" value="_UForget">
                                <button id="_UForget_Btn" class="btn btn-warning">Continue</button>
                            </div>
                        </form>
        ...
        $(document).ready(function() {
            $(document).on('click', '#_UForget_Btn', function () {
          var datastring = $('#_UForget').serialize();
          $.ajax({
            method: 'POST',
            data: datastring,
