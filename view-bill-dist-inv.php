                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            <address>
                                                               ...
                                                               <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add"><b>GSTIN\UIN :</b> 33AADCC7429F1ZV</span>
                                                                </div>
                                                            </address>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            <address>
                                                                ...
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add"><?php echo $owner;?></span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add"><?php echo $store;?></span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add"><b>GSTIN\UIN :</b> <?php echo $gst_number; ?></span>
                                                                </div>
                                                                <?php
                                                                    if($tcs_type == 2)
                                                                    {
                                                                ?>
                                                                    <div class="col-md-12 disp_addrs">
                                                                        <span class="user_order_add"><b>TCS No :</b> <?php echo $tcs_no; ?></span>
                                                                    </div>
                                                                <?php
                                                                    }
                                                                ?>
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add"><b>Sales Excutive :</b> <?php echo $excut_name; ?></span>
                                                                </div>
                                                            </address>
                                                        </div>
                                                    </div>
                                ...
                                <?php
                                    ...
                                    while($row_2 = mysqli_fetch_array($qry_2)) 
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo !empty($row_2['code'])?$row_2['code']:'';?> 
                                            <td><?php echo !empty($row_2['hsn'])?$row_2['hsn']:'';?></td>
                                            <td><?php echo !empty($row_2['price'])?$row_2['price']:'';?></td>
                                            <td><?php echo !empty($row_2['qty'])?$row_2['qty']:'';?></td>
                                            ...
                                            <?php
                                                ...
                                                {
                                                    ?>
                                                        <td><?php echo round($gst_value);?> %</td>
                ...
                ?>
                    <div class="d-print-none">
                        <div class="pull-right">
                            <a  href="invoice/distributor-print.php?id=<?php echo $order;?>" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                        </div>
                    </div>
                <?php
            }
