...
<style type="text/css">
    ...
    <body class="fixed-left">
        ...
        <?php include 'includes/side_menu.php';  ?>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            ...
                                                            {
                                                                $qry_0 = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM `ss_distributors` WHERE id = '".$addressdetail->userid."'"));
                                                            ?>
                                                            <address>
                                                                <strong>Billed To:</strong><br>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add"><strong><?php echo $qry_0->store;?></strong></span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add"><?php echo $qry_0->owner;?></span>
                                                                </div>
                                                                
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add"><?php echo $qry_0->customeraddress; ?></span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                                
                                                                    <span class="user_order_add"><?php echo $qry_0->mobile;?></span>
                                                                </div>
                                                                 <div class="col-md-12 disp_addrs">
                                                                
                                                                    <span class="user_order_add"><?php echo $qry_0->gst ? $qry_0->gst : '---'; ?></span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                                
                                                                    <span class="user_order_add"><?php echo $qry_0->email_id;?></span>
                                                                </div>
                                                            </address>
                                                        <?php } ?>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            ...
                                                            <address>
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add"><?php if($qry_1->pincode !=0){ echo $qry_1->pincode.', '.$qry_1->address; } ?></span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                                ...
                                                                <?php
                                                                  ...
                                                                  <div class="col-md-12 disp_addrs">
                                                                      ...
                                                                      <span class="user_order_add">TCS No : <?php echo $qry_1->tcs_no ? $qry_1->tcs_no : '---'; ?></span>
                                                                  </div>
                                                                  <?php
                                                                      }
                                                                  ?>
            ...
            $serial = mysqli_query($conn, "SELECT * FROM `ss_item_stk` WHERE `product_id` = '".$row['pid']."' AND `delar_sales` = '".$row['so_no']."' AND published = '1'");
