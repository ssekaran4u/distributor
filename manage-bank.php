                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Bank</strong></h4>
                                            <hr>

                                            <div class="col-md-6 pdz">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search Bank Name..." value="">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-bank"><i class="fa fa-plus-circle"></i>  Add New Bank</a> </h4>
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="sorting" data-sort="0">
                                                                ...
                                                                <i class="filter hide fa fa-sort show"></i> Bank Name
