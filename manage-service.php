...
<html>
    ...
    <body class="fixed-left">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Service</strong></h4>
                                            <hr>

                                            <div class="col-md-6 pdz">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search Serice No..." value="">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-service"><i class="fa fa-plus-circle"></i>  Add New Service</a> </h4>
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="sorting" data-sort="0">
                                                                ...
                                                                <i class="filter hide fa fa-sort show"></i> Service No
        ...
        <div class="modal fade" id="service_view" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title text-left">Service Info</h4>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '.service_view', function () {
              ...
              $.ajax({
                type: 'POST',
                url: 'inc/service-model-view.php',
                data: {
                  'id': id,
                  'method': 'view'
                },
            ...
            $('#service_view').on('hidden.bs.model', function () {
              alert('sdhjhg');
            });
        </script>
    </body>
