...
<html>
    ...
    <body class="fixed-left">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title clearfix"><strong>Create Sales Executive</strong> <a class="pull-right btn btn-pink" href="manage-sales-executive"><i class="fa fa-plus-circle"></i> Manage Sales Executive</a></h4>
                                            <hr>
                                            ...
                                            <form id="employee-form" name="employee-form" method="post">
                                                ...
                                                <button type="submit" id="employee-form" class="btn btn-danger waves-effect waves-light add-employee"> <i  class="mdi mdi-check-circle-outline"></i> Add Sales Executive </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="assets/Ajax/ajax-sales-executive.js"></script>
