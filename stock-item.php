                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card m-b-30">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Stock</strong></h4>

                                            <hr>

                                            <input type="hidden" value="<?php echo $order; ?>" name="pdid" id="pdid">

                                            <div class="col-md-4 fl pdz">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search Serial Number..." value="">
                                                  ...
                                                  <thead>
                                                      ...
                                                      <tr>
                                                          ...
                                                          <th class="sorting" data-sort="0">
                                                              ...
                                                              <i class="filter hide fa fa-sort show"></i> Serial Number

                                                          </th>

                                                          <th class="sorting text-center" data-sort="1">

                                                              <i class="filter hide fa fa-sort"></i>  PO Number

                                                          </th>

                                                          <th class="sorting text-center" data-sort="1">

                                                              <i class="filter hide fa fa-sort"></i>  Invoice Number
