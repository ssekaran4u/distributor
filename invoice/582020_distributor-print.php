        ...
        if($_coun > 0)
        {
            ...
            while($_RES = mysqli_fetch_object($_QRY))
            {
                ...
                $html .= '
                    ...
                    <tr><td colspan="12">Serial No: '.$serial_val.'</td></tr>
                ';
            ...
            <tr>
                ...
                if($state == 33)
                {
                    $html .='<td style="text-align: right; font-size:12px;" class="no-line">Rs.'.round($gst_val).'</td>
                            <td style="text-align: right; font-size:12px;" class="no-line"></td>
                ...
                $html .='<td style="text-align: right; font-size:12px;" class="no-line">Rs.'.round($_total).'</td>
            </tr>
            <tr>
