				...
				if($fileData)
				{
					...
					foreach($datas as $rawRow)
					{
						...
						if($row_1)
						{
							...
							{
								$upt_1 = mysqli_query($conn, "UPDATE `ss_item_stk` SET `dist_id`='".$customer_id."',`sales_no` = '".$so_no."' , `sales_date` = '".date('Y-m-d', strtotime($dated))."', `status` = '0', `delar_status` = '0' WHERE `code` = '".$code."' ");
							}
							...
							// {
								...
								if($sel_4->avl_lmt > $last_tot)
								{
									...
									if($row_3 > 0)
									{
										...
										{	
											$ins_1 = mysqli_query($conn, "INSERT INTO `ss_distributor_inv_details`(`so_id`, `so_no`, `customer_id`, `cid`, `pid`, `code`, `hsn`, `qty`, `price`, `gst`, `allowance`, `sta`, `d_allowance`, `total_cost`, `dated`, `createdate`) VALUES ('".$so_re."', '".$so_no."', '".$customer_id."', '".$sel_3->cid."', '".$sel_3->id."', '".$sel_3->description."', '".$sel_3->hsn."', '".$qty."', '".$sel_3->oprice."', '".$sel_3->gst."', '".$sel_3->allowance."', '".$sel_3->sta."', '".$sel_4->d_allowance."', '".$last_tot."', '".date('Y-m-d', strtotime($dated))."', NOW())");
										}
									...
									else
									{
										...
										$ins_3 = mysqli_query($conn, "INSERT INTO `ss_distributor_inv_details`(`so_id`, `so_no`, `customer_id`, `cid`, `pid`, `code`, `hsn`, `qty`, `price`, `gst`, `allowance`, `sta`, `d_allowance`, `total_cost`, `dated`, `createdate`) VALUES ('".$so_re."', '".$so_no."', '".$customer_id."', '".$sel_3->cid."', '".$sel_3->id."', '".$sel_3->description."', '".$sel_3->hsn."', '".$qty."', '".$sel_3->oprice."', '".$sel_3->gst."', '".$sel_3->allowance."', '".$sel_3->sta."', '".$sel_4->d_allowance."', '".$last_tot."', '".date('Y-m-d', strtotime($dated))."', NOW())");
			...
			if($rsrow==0)
			{
				...
				if($avl_lmt > $last_tot)
				{
					...
					if($num_1 > 0)
					{
						...
						$ins_1 = "INSERT INTO `ss_distributor_inv_details`(`so_id`, `so_no`, `customer_id`, `cid`, `pid`, `code`, `hsn`, `qty`, `price`, `gst`, `allowance`, `sta`, `d_allowance`, `discount`, `total_cost`, `dated`, `createdate`) VALUES ('".$so_id."', '".$so_no."', '".$customer_id."', '".$cid."', '".$pid."', '".$description."', '".$hsn."', '".$qty."', '".$price."', '".$gst."', '".$allowance."', '".$sta."', '".$d_allowance."', '".$discount."', '".$last_tot."', '".date('Y-m-d')."', NOW())";
					...
					else
					{
						...
						$ins_3 = "INSERT INTO `ss_distributor_inv_details`(`so_id`, `so_no`, `customer_id`, `cid`, `pid`, `code`, `hsn`, `qty`, `price`, `gst`, `allowance`, `sta`, `d_allowance`, `discount`, `total_cost`, `dated`, `createdate`) VALUES ('".$so_re."', '".$so_no."', '".$customer_id."', '".$cid."', '".$pid."', '".$description."', '".$hsn."', '".$qty."', '".$price."', '".$gst."', '".$allowance."','".$sta."', '".$d_allowance."', '".$discount."', '".$last_tot."', '".date('Y-m-d')."', NOW())";
