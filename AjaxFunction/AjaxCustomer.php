...
if($_POST['method'] =='add-customer')
{
    ...
    if($importtype == 1)
    {
    	$required = array('dist_name' ,'name', 'email', 'mobile', 'credit_lmt', 'cname', 'address', 'state_id', 'pincode', 'excutive');
    }
    else if($importtype == 2)
    {
    	$required = array('dist_name' ,'name', 'email', 'mobile', 'credit_lmt', 'cname', 'address', 'state_id', 'pincode', 'excutive', 'tcs_no');
    }
