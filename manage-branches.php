                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card m-b-30">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage Branches</strong> <!-- <a class="pull-right btn btn-pink" href="create-branch"><i class="fa fa-plus-circle"></i>  Add New Branch</a> --> </h4>

                                            <hr>

                                            <div class="col-md-6 pdz d-none">

                                                <input id="search" name="dSuggest" type="text" class="form-control"  placeholder="Search by Name..." value="">

                                            </div>

                                            <div class="col-md-2 pdz d-none">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="sorting text-center" data-sort="2">
                                                            ...
                                                            <!-- <th class="sorting text-center" data-sort="4">
        ...
        //alert('dshgfdhg');
         ...
         var id=$(this).data('id');
          ...
          $.ajax({
            ...
            data: {'id':id,'method':'delete','setfield':'status','whrfield':'id','tabname':'ss_coupon_code'},
