                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title clearfix"><strong>Manage City</strong></h4>
                                            <hr>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 class="mt-0 header-title clearfix"> <a class="pull-right btn btn-pink" href="create-city"><i class="fa fa-plus-circle"></i>  Add New City</a> </h4>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sorting" data-sort="1">
                                                                <i class="filter hide fa fa-sort show"></i> City Name
                                                            </th>
