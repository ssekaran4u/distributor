                                            ...
                                            <form id="<?php echo isset($fetch->id) ? 'edit' : 'add'; ?>-form" name="<?php echo isset($fetch->id) ? 'edit' : 'add'; ?>-form" method="post" enctype="multipart/form-data">
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="form-control brand_name[] js-select9-multi" name="b_id" id="b_id">
                                                ...
                                                <div class="row clearfix mb20">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="typesimpo" style="margin-top: 12px;">
                                                            <input type="radio" class="importtype" name="importtype" value="2" checked> Import
                                                            <input type="radio" class="importtype" name="importtype" value="3"> Entry
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 hide qtyval">
                                                        <span>Qty <span class="text-danger">*</span> </span>
                                                        <input  type="text" name="qty" class="form-control qty" id="qty" placeholder="Qty" value="<?php echo isset($fetch->sta) ? $fetch->sta : '' ?>">
                                                    </div>
                                                    <div class="col-md-4 csvval">
                                                        ...
                                                        Format : <a href="assets/serial_format.csv">Download CSV</a>
                                                    </div>
                                                </div>
                                                <div class="row clearfix mb20">
                                                    <!-- <div class="col-md-12"> -->
                                                ...
                                                <button type="submit" id="<?php echo isset($fetch->id) ? 'edit' : 'add'; ?>-form" class="btn btn-danger waves-effect waves-light <?php echo isset($fetch->id) ? 'edit' : 'add'; ?>-item"> <i  class="mdi mdi-check-circle-outline"></i> <?php echo isset($fetch->id) ? 'Edit' : 'Add'; ?> Inventory </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
            ...
            $(document).ready(function(){
                ...
                $('#qty').keyup(function(){     
                    ...
                    { 
                        ...
                        {
                            // console.log(i);
                            html += '<div class="col-md-3 form-group" style="float: left;"><input type="text" data-te='+i+' name="code[]" style="min-width: 140px !important; max-width: 140px !important;" class="datqul inputs form-control code quantity'+i+'" id="code'+i+'" value="" /></div>';
                        }
